...
describe('Startup a goal', () => {
    ...
    before(() => {
        ...
        cy.get('ion-picker-column-option[ng-reflect-value="120"]')
            .realClick()
    ...
    it('Verify recommended weight for registration matches current weight', () => {
        ...
        cy.get('app-weight-form').should('be.visible').should('have.attr','ng-reflect-input-weight-value', '120')
    })
